      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                type="number"
                defaultValue="100"
                className="bg-[#0b1014] border-[#1f2930] text-zinc-200"
              />
            </div>
        ...
        <div className="bg-[#131b20] border border-[#1f2930] rounded-xl p-6 flex flex-col">
          ...
          <div className="flex items-end gap-2">
            <h2 className="text-5xl font-bold text-zinc-100 tracking-tight">
              14,208
            </h2>
      ...
      <div className="bg-[#131b20] border border-[#1f2930] rounded-xl overflow-hidden mt-6">
        <div className="p-4 border-b border-[#1f2930] flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <span className="px-3 py-1 bg-[#1a242a] text-zinc-300 text-xs font-medium rounded border border-[#25323a]">
              Active
            </span>
            <span className="px-3 py-1 text-zinc-500 text-xs font-medium border border-transparent">
              Expired
            </span>
          </div>
        </div>
            ...
            <tbody className="divide-y divide-[#1f2930]">
              {liveInventory.map((item, idx) => (
                <tr key={idx} className="hover:bg-[#1a242a] transition-colors">
                  ...
                  <td className="p-4 text-zinc-300 text-sm font-medium">
                    {item.tier}
                  </td>
                  ...
                  <td className="p-4">
                    ...
                    >
                      {item.status === "Active" && (
                        <span className="h-1.5 w-1.5 rounded-full bg-[#98e9a8]"></span>
                      )}
